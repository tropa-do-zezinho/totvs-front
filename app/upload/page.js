  ...
  return (
    <main className="flex flex-1 flex-col items-center p-4 py-16">
      <div className="w-full max-w-xl">
        ...
        <h1 className="mt-1 font-display text-2xl font-medium">Enviar arquivo ao MoodLens</h1>
        <p className="mt-2 text-sm text-foreground-dim">
          Envie suas reuniões e acompanhe a análise por aqui. Assim que terminar,
          os resultados estarão disponíveis no seu painel.
        </p>
