...
export default function DashboardPage() {
  ...
  return <main className="flex-1 px-4 py-10 sm:px-6 sm:py-14"><div className="mx-auto max-w-5xl">
    <div className="flex flex-wrap items-end justify-between gap-5"><div><p className="font-mono text-xs uppercase tracking-[0.18em] text-cyan-deep">Fábrica de insights / espaço de trabalho</p><h1 className="mt-3 font-display text-3xl font-medium tracking-tight sm:text-4xl">Suas análises, em um só lugar.</h1><p className="mt-2 max-w-xl text-sm text-foreground-dim">Acompanhe cada arquivo enviado e abra os resultados quando a análise terminar.</p></div><Link href="/upload" className="rounded-xl bg-cyan px-5 py-3 font-display text-sm font-medium text-ink focus-visible:outline-2 focus-visible:outline-cyan">Enviar arquivo ↗</Link></div>
